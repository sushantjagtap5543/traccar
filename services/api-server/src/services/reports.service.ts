...
export class ReportsService {
  ...
  async getTrips(userId: string, deviceId: string, from: string, to: string) {
    ...
    return this.traccarService.getTripReport(Number(device.traccarDeviceId), from, to);
  }
  ...
  async getStops(userId: string, deviceId: string, from: string, to: string) {
    ...
    return this.traccarService.getStopReport(Number(device.traccarDeviceId), from, to);
  }
  ...
  async getSummary(userId: string, deviceId: string, from: string, to: string) {
    ...
    return this.traccarService.getSummaryReport(Number(device.traccarDeviceId), from, to);
  }
}
