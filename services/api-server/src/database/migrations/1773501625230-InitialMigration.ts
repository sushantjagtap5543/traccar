...
export class InitialMigration1773501625230 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "clientId" uuid, "name" character varying, "email" character varying, "mobile" character varying NOT NULL, "company" character varying, "address" text, "password" character varying, "isOtpVerified" boolean NOT NULL DEFAULT false, "otpCode" character varying, "otpExpiresAt" TIMESTAMP, "role" character varying NOT NULL DEFAULT 'CLIENT', "disabled" boolean NOT NULL DEFAULT false, "status" character varying NOT NULL DEFAULT 'active', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_d376a9f93bba651f32a2c03a7d3" UNIQUE ("mobile"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
