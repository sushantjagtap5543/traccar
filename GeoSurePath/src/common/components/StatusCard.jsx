...
const StatusCard = ({ deviceId, position, onClose, disableActions, desktopPadding = 0 }) => {
  ...
  const positionItems = useAttributePreference(
    'positionItems',
    'fixTime,address,speed,totalDistance,distance',
  );
          ...
          >
            <Card elevation={3} className={classes.card}>
              ...
              <CardActions classes={{ root: classes.actions }} disableSpacing>
                ...
                <Tooltip title="Engine Cut">
                  <IconButton
                    color="error"
                    onClick={() => sendCommand('engineStop')}
                    disabled={disableActions}
                  >
                    <PowerSettingsNewIcon />
                  </IconButton>
                </Tooltip>
                <Tooltip title="Engine Restore">
                  <IconButton
                    color="success"
                    onClick={() => sendCommand('engineResume')}
                    disabled={disableActions}
                  >
                    <RestartAltIcon />
                  </IconButton>
