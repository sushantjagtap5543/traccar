...
import MapGeofenceDirect from '../map/main/MapGeofenceDirect';
import MapGeofenceDrawer from '../map/main/MapGeofenceDrawer';
...
const MainMap = ({ filteredPositions, selectedPosition, onEventsClick }) => {
  ...
  return (
    <>
      <MapView>
        <MapOverlay />
        <MapGeofenceDirect onSelect={(id) => setSelectedGeofenceId(id)} />
